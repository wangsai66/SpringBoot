...
public class ShiroConfiguration  {
	...
	*//**
	 ...
	 * @return
	 * @version 1.0  2018年4月13日 上午11:57:47  by 王赛(wangsai@zhihuihutong.com)
	 *//*
    ...
    *//**
     ...
     * 需借助SpringAOP扫描使用Shiro注解的类,并在必要时进行安全逻辑验证 * 配置以下
     * 两个bean(DefaultAdvisorAutoProxyCreator(可选)和AuthorizationAttributeSourceAdvisor)即可实现此功能 * @return
     *//*
    @Bean
